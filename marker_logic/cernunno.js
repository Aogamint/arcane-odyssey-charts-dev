...
function addCernunno(map) {

    // New layer with id `collectibles` from geoJSON `collectibles`
    map.addInteractiveLayer('Cernunno', cernunno, {
        ...
        sidebar_icon_html: '<h style="font-weight:bolder; justify-content: space-around; display: flex">Ce</h>',
